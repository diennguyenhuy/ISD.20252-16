    ...
    <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {passwordResetDone && (
        <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 rounded-2xl p-4 mb-6 text-sm font-bold flex items-center gap-2 animate-in zoom-in-95 duration-300 shadow-sm">
          ...
          Email reset password has been sent to <strong>{user.email}</strong>
        </div>
      )}
      ...
      <div className="bg-card rounded-3xl border border-border shadow-lg overflow-hidden mb-8 relative">
        <div className="relative px-6 py-10 text-center border-b border-border bg-muted/10 overflow-hidden">
          ...
          <h2 className="text-2xl font-extrabold text-foreground relative z-10 tracking-tight">{user.username}</h2>
      ...
      <div className="bg-card rounded-3xl border border-border shadow-md p-6 sm:p-8 space-y-2">
        <h3 className="text-foreground font-bold text-lg mb-6 border-b border-border/50 pb-4 flex items-center gap-2">
          <Shield size={20} className="text-destructive" />
          Admin Actions
        </h3>

        {/* Activate/Deactivate */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between py-4 border-b border-border/50 gap-4">
          <div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between py-4 gap-4">
          <div>
            ...
            <p className="text-xs font-medium text-muted-foreground mt-1">Send password reset link via email</p>
          </div>
          <button
